...
# Package names
packages <- c("tidyverse", "zoo", "patchwork", "hrbrthemes", "rjson", "jsonlite", "DT")
...
#-------------------------------------------------------Exportar datos--------------------------------------------------------------------------#
# Info: https://rstudio.github.io/DT/ y https://www.rdocumentation.org/packages/DT/versions/0.18/topics/datatable
